...
flowchart TD
    subgraph "Complete Search Space"
        ...
        subgraph "Neural Networks"
            HL[Hidden Layers<br/>1-4]
            HN[Hidden Units<br/>16-128]
            DR[Dropout Rate<br/>0.0-0.5]
            BS[Batch Size<br/>32-256]
            LRN[Learning Rate<br/>0.0001-0.01]
        end
...
flowchart TB
    ...
    MP --> NNP[Neural Network Parameters]
...
search_space.add(Parameter::new("hidden_layers", ParameterType::Int(1, 4)));
search_space.add(Parameter::new("hidden_units", ParameterType::Int(16, 128)));
search_space.add(Parameter::new("dropout_rate", ParameterType::Float(0.0, 0.5)));
search_space.add(Parameter::new("batch_size", ParameterType::Int(32, 256)));
search_space.add(Parameter::new("learning_rate_nn", ParameterType::Float(0.0001, 0.01)));
