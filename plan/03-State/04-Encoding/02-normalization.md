...
```rust
// Tile values are powers of 2: 0, 2, 4, 8, ..., 65536
...
```rust
// All count features are bounded:
// empty_count: [0, 16] → [0, 1]
// available_moves: [0, 4] → [0, 1]
...
let config = PreprocessingConfig::default()
    .with_scaler_type(ScalerType::Standard)  // Z-score standardization
    .with_imputation_strategy(ImputationStrategy::Mean)
    .with_encoding(EncodingType::None);       // No categorical encoding needed
