...
## 6. Output Layer Configurations

```mermaid
graph TD
    subgraph OutputLayers["Model Output Configurations"]
        OL1["Regression: 4 outputs"]
        OL2["Classification: 4 outputs + Softmax"]
        OL3["Multi-head: Separate heads per direction"]
    end
    OL1 -->|Argmax| Action["Selected Action"]
    OL2 -->|Softmax| Prob["Action Probabilities"]
    OL3 -->|Max| Best["Best Direction"]
```
