...
flowchart TD
    subgraph "Feature Engineering Pipeline"
        ...
        Validate --> Output[Feature Vector: 25 dims]
...
flowchart TB
    subgraph "Feature Categories"
        ...
        DerivedFeat[Derived Features<br/>9 dimensions]
    end
    ...
    DerivedFeat --> Corner[Corner Value<br/>20]
    DerivedFeat --> Moves[Available Moves<br/>21]
    DerivedFeat --> Merges[Merges Available<br/>22]
    DerivedFeat --> Score[Score Normalized<br/>23]
    DerivedFeat --> MoveCount[Move Count Norm<br/>24]
...
flowchart TD
    ...
    Step3 --> Step4
    Step4 --> Step5
    Step5 --> Final[25-dim Feature Vector]
...
flowchart TB
    ...
    Ranking --> Bottom[move_count_norm - Lowest]
...
pub struct FeatureEngineeringConfig {
    ...
    pub target_dimensions: usize,  // 25
}
```
