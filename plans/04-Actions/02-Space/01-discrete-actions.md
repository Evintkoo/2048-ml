...
> **Canonical:** `04-Actions/01-Action/01-action-space.md` — see there. This file is a reference stub, identical for historical reasons; do not duplicate action-space definition.

## 1. Overview

The 2048 game operates on a discrete action space with exactly 4 possible moves. See canonical for authoritative definition.
