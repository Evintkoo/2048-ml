...
flowchart TD
    ...
    Feature --> Dim[Dimension: 27]
    Feature --> Type[Type: f64]
    Feature --> Range[Range: [0, 1]]
    Feature --> Order[Order: Fixed — canonical 16 grid + 11 derived]
...
flowchart LR
    ...
    F6 --> F7[monotonicity]
    F7 --> F8[smoothness]
    F8 --> F9[merges_available]
    F9 --> F10[score_normalized]
    F10 --> F11[adjacency_merge_score]
    F11 --> F12[corner_max]
    F12 --> F13[edge_tiles_occupied]
    F13 --> F14[col_worst]
    F14 --> F15[row_worst]
