# 02-Configuration — plan by plan execution
...
| Plan | Subject | Status |
|---|---|---|
| [01-automl-config](01-automl-config.md) | AutoML Configuration | PARTIAL |
| [02-training-config](02-training-config.md) | Training Pipeline Configuration | PARTIAL |
